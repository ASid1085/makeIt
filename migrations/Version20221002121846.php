 ...
 */
final class Version20221002121846 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create relation between projects table and users table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projects DROP steps');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projects ADD steps JSON NOT NULL');
    }
}
